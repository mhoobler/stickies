...
var _indexedDBJs = require("./indexedDB.js");
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _indexedDBJsDefault = _parcelHelpers.interopDefault(_indexedDBJs);
...
function getStickies() {
  _indexedDBJsDefault.default().then(res => {
...
},{"../styles/style.scss":"2zgbc","./indexedDB.js":"5ZhKs","@parcel/transformer-js/lib/esmodule-helpers.js":"1T3iH"}],"2zgbc":[function() {},{}],"5ZhKs":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
const getTransaction = async db => new Promise((resolve, reject) => {
...
const initDB = async () => new Promise((resolve, reject) => {
  ...
  request.onupgradeneeded = evt => {
    ...
    stickiesStore.createIndex("id", "id", {
      unique: true
    });
    stickiesStore.createIndex("message", "message", {
      unique: false
    });
    stickiesStore.createIndex("color", "color", {
      unique: false
    });
    stickiesStore.createIndex("left", "left", {
      unique: false
    });
    stickiesStore.createIndex("top", "top", {
      unique: false
    });
  };
});
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"1T3iH"}],"1T3iH":[function(require,module,exports) {
"use strict";
...
},{}]},["6ijR0","3GZMZ"], "3GZMZ", "parcelRequiree548")
